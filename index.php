...
<div class="align text-center" >
	...
	<div id="xpengumuman">
				...
				if ($data['status'] == 1) { ?>
					<form method="post" action="print/" target="_blank">
						...
						<div class="alert alert-success" role="alert">
							...
							<br><i>Untuk Mendapatkan Surat Keterangan LULUS Silahkan Datang Kesekolah</i> &nbsp; &nbsp; <br>
		...
		<center style="float: top;font-size: 16px;color: #008000"><p>Masukkan nomor Ujian pada kolom yang disediakan</p></center>
